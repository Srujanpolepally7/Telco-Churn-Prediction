...
app = Flask(__name__, template_folder= (r"C:\Users\Spekerod\Desktop\Srujan\New Project\auth"))
adaboost = pickle.load(open(r"C:\Users\Spekerod\Desktop\Srujan\New Project\log_model.pkl", 'rb'))

@app.route('/')

def home():
    return render_template(r"register.html", query = "")
